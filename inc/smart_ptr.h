...
namespace ltd
{
    ...
    /**
     * @brief
     * This the default object deleter for `class object`.
     * 
    ...
    /**
     * @brief
     * Encapsulates pointers into reference counted pointers.
     * 
    ...
    public: // ctors
        ...
        /**
         * @brief
         * Construct a new empty pointer object.
         */
        ...
        /**
         * @brief
         * Construct a new pointer from a raw pointer and a referenect counter.
         * 
        ...
        /**
         * @brief
         * Construct a new pointer by moving from other pointer.
         * 
        ...
        /**
         * @brief
         * Construct a new pointer object from other pointer.
         * 
        ...
        /**
         * @brief
         * Test whether the pointer is a valid pointer.
         * 
    ...
    /**
     * @brief
     * Represents an object on heap and manages its lifetime automatically.
     * 
    ...
    public: // ctors
        ...
        /**
         * @brief
         * Construct a new object by using a block memory where the
        ...
        /**
         * @brief
         * Construct a new object by moving from other object.
         * 
    ...
    public: // operations
        ...
        /**
         * @brief
         * Checks whether the object is still in a valid state.
         * 

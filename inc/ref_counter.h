...
namespace ltd
{
    ...
    /**
     * @brief Reference counter for atomic reference counting.
     * 
    ...
    public: // Constructors
        ...
        /**
         * @brief Get the data from the reference counter.
         * 
        ...
        /**
         * @brief Set the data in the reference counter.
         * 
        ...
        /**
         * @brief Test bit on the stored data.
         * 
        ...
        /**
         * @brief Set the data bit in the storage to 1.
         * 
        ...
        /**
         * @brief Unset the data bit in the storage to 0.
         * 
